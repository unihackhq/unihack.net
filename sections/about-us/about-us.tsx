import { H2, H3, HXL, Text } from '@components/typography/typography';
  ...
  <section className={styles['about-us']}>
    <div className={styles['about-us-content']}>
      ...
      <Text>
        ...
        opportunity to build, collaborate and learn from your fellow hackers and
        mentors at the event. The event will also have a number of quick tech
        talks throughout to help participants learn new or extend their existing
        skills.
      </Text>
    </div>
  </section>
