          ...
          <Stack size="medium">
            ...
            <div className={styles['introduction']}>
              **We believe that every single person has the right to hack in a
              safe and welcoming environment.** This is why we have a code of
              conduct that applies to participants, sponsors, judges, mentors,
              organisers, volunteers, guests, observers and any other person at
              a UNIHACK event, or any online interactions in relation to a
              UNIHACK event (e.g. Discord, Slack, the UNIHACKers Facebook
              Group).
            </div>
            <Rules />
          </Stack>
