      ...
      <div className={styles.location}>
        ...
        <div className={styles.row}>
          <div className={styles.address}>
            <h3>Address</h3>
            <p>
              G22, Electrical Engineering Building (G17)
              <br />
            ...
            <ButtonLink
              theme="light"
              type="primary"
              href="https://link.mazemap.com/8DO6SnuZ"
            >
              Directions
            </ButtonLink>
          </div>
...
export default () => (
  <div>
    <Head>
      <title>UNIHACK 2024 - Sydney Hub at UNSW - March 1-3 2024</title>
      <meta
        property="og:title"
        content="UNIHACK 2024 - Sydney Hub at UNSW - March 1-3 2024"
        key="title"
      />
    </Head>
    <Page headerless>
