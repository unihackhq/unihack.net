        ...
        <div className={styles.links}>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <Link prefetch={false} href="/rules">
                  Event Rules
                </Link>
              </li>
              <li>
                <Link prefetch={false} href="/conduct">
                  Code of Conduct
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul>
              <li>
                <Link prefetch={false} href="https://tiktok.com/@unihackhq">
                  TikTok
                </Link>
              </li>
              <li>
                <Link prefetch={false} href="http://instagram.com/unihack">
                  Instagram
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link prefetch={false} href="https://x.com/UNIHACKHQ/">
                  Twitter/X
                </Link>
              </li>
              <li>
