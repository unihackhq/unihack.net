    ...
    return (
        <> 
            ...
            <PageContent className={styles.content}>
                <h1>About Us</h1>
                <p className={styles.intro}>We are Australia's <span>largest</span> student hackathon.</p>
                <p>
                    Join hundreds of university students from across Australia and New Zealand as they spend
                    a weekend of creativity, learning, and building solutions to problems. Teams of up to six
                    students have around 48 hours to design, build and pitch a prototype.
                </p>
                <p>
                    We are called <strong className={styles.imagination}>The Imagination Hackathon</strong> as we do not prescribe an official theme. Students
                    are free to create whatever idea they choose, in whatever format they wish - such as a website,
                    a mobile app, a game, or even a piece of hardware. The most important thing is that it must work
                    when presented.
                </p>
                <p>
                ...
                <p>
                    Our competition past winners and previous participants are highly valued - working at some of the biggest names
