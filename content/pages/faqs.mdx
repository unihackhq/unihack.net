...
Unless specified in a judging criteria for a sponsor prize, we are not evaluating
your code quality (and we're not in any position to judge either). However, please ensure all secrets
